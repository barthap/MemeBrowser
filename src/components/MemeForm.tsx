...
import { Card, CardItem, Text, Left, Body, Item, Input, Textarea, Button, Label, Picker } from 'native-base';
  ...
  return (
    <Card style={{ flex: 0 }}>
      ...
      >
        ...
        <Picker mode="dropdown" style={{ width: 120 }} selectedValue={lang} onValueChange={handleLangChange}>
